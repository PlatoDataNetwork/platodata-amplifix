              ...
              <div className="flex flex-col gap-4 pt-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">Military-grade encryption protecting all data transfers</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold mb-2">Decentralized Architecture</h4>
                    <p className="text-muted-foreground text-sm">Distributed network ensuring no single point of failure</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">24/7 threat detection and automated response systems</p>
                  </div>
                </div>
              </div>
            </div>
